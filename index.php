...
<div class="downloader">
 ...
 <div class="main">
    <form action="<?php $_SERVER['PHP_SELF'] ?>" method="POST">
         <input type="text" name="video_url" placeholder="Colar URL do vídeo..." autocomplete="off">
     ...
     if($isVideoIdValid=="0"){ ?>
      <div class="instruction_box">
         ...
         <h3>O URL inserido é inválido</h3>
          <p>Verifique se o URL é válido</p>
       </div>
     <?php }else if($isvalid==""){ ?>
       <div class="instruction_box">
         <label><i class='bx bx-link'></i></label>
         <h3>Copie o URL do vídeo e cole aqui</h3>
         <p>Verifique se o URL é válido</p>
       </div>
...
<?php if(!empty($formats)){
  ...
  <div class="instruction_box">
    ...
    <h3>Sem suporte</h3>
    <p>Este vídeo não é compatível no momento</p>
  </div>
...
<?php } } }else{ ?>
     ...
     <div class="instruction_box">
       <label><i class='bx bx-video-off'></i></label>
       <h3>Não foi possível buscar as informações do vídeo</h3>
       <p>Verifique se o URL é válido</p>
     </div>
